...
file_save = 'Diagramme_PV_par_pdf_output'+str(output)+'_dr'+str(dr)+'AU.hdf5'
...
#plt.figure()
#plt.plot(shells_au, M_cumul_tab/M_sun, marker=marker, linestyle='None')
#plt.xlabel(ur'Rayon (AU)')
#plt.ylabel(ur'Masse cumulee (masse solaire)')

#plt.figure()
#plt.plot(shells_au, M_int_tab/M_sun, marker=marker, linestyle='None')
#plt.xlabel(ur'Rayon (AU)')
#plt.ylabel(ur'Masse dans chaque coquille (masse solaire)')


#plt.figure()
#plt.plot(shells_au, V_r_shell_moy_tab, marker=marker, label=legend+'  - '+tag, linestyle='None')
#plt.xlabel(ur'Rayon (AU)')
#plt.ylabel(ur"Vitesse radiale moyenne($m.s^{-1}$)")
#plt.legend(loc='best')
