...
#------------------------------------------
#Debut de la fonction pour faire les images
#------------------------------------------
    ...
    if selon_x==True:
        ...
        if fleche_vel == True:
            ...
            if radius_zoom==5:
                ...
                plt.ylim([0,lbox_au])
            if save==True:
                plt.savefig(path_save+'dens_x_'+str(radius_zoom)+'_%05d'%num_output+'.png', bbox_inches='tight')
            plt.close()
        ...
        if v_proj == True:
            ...
            if radius_zoom==5:
                ...
                plt.ylim([0,lbox_au])
            if save==True:
                plt.savefig(path_save+'vel_x_'+str(radius_zoom)+'_%05d'%num_output+'.png', bbox_inches='tight')
    ...
    if selon_y==True:
        ...
        if fleche_vel == True:
            ...
            if radius_zoom==5:
                ...
                plt.ylim([0,lbox_au])
            if save==True:
                plt.savefig(path_save+'dens_y_'+str(radius_zoom)+'_%05d'%num_output+'.png', bbox_inches='tight') 
            plt.close()
        ...
        if v_proj == True:
            ...
            if radius_zoom==5:
                ...
                plt.ylim([0,lbox_au])
            if save==True:
                plt.savefig(path_save+'vel_y_'+str(radius_zoom)+'_%05d'%num_output+'.png', bbox_inches='tight')
            plt.close()
    ...
    if selon_z==True:
        ...
        if fleche_vel == True:
            ...
            if radius_zoom==5:
                ...
                plt.ylim([0,lbox_au])
            if save==True:
                plt.savefig(path_save+'dens_z_'+str(radius_zoom)+'_%05d'%num_output+'.png', bbox_inches='tight')
            plt.close()
        ...
        if v_proj == True:
            ...
            if radius_zoom==5:
                ...
                plt.ylim([0,lbox_au])
            if save==True:
                plt.savefig(path_save+'vel_z_'+str(radius_zoom)+'_%05d'%num_output+'.png', bbox_inches='tight')
            plt.close()
...
#------------------------------
#Lancement du calcul des images
#------------------------------
if owner=='averliat':
    path='/mnt/magmist/magmist/simu_B335_averliat/'+simu+'/'
if owner=='phennebe':
...
outputs=np.linspace(output_min,output_max,(output_max-output_min+1))

for num_output in outputs:
    if os.path.isdir(path+'output_'+str(int(num_output)).zfill(5)) == True:
        image(simu,owner,int(num_output),dir_save)
