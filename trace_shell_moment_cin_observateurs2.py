...
#-----------------------------------------------------------
    ...
    simu='B335_noturb_norot_hydro_pert_asym_aleatoire_shr_bigbox_'+tag
...
def trace_moment_cin_disque(simu,tag,output_min_disque,output_min_global,output_max,width_bar,hist,diff_abs,diff_relat,legend,marker,t1=0.,seuil_rho=1e-10,moyenne_glissante=True):
#------------------
#Differents chemins
#------------------
...
if __name__=='__main__':
        trace_moment_cin_disque(simu,tag,output_min_disque,output_min_global,output_max,width_bar,hist,diff_abs,diff_relat,legend,marker,moyenne_glissante)
