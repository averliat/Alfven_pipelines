...
radius_cell = np.sqrt( np.sum( (pos[:,:]-pos_center)**2 , axis=1 ) )  #Tableau contenant le rayon de chaque cellule par rapport au centre du disque
pos_rel = pos[:,:] - pos_center #vecteur centre du disque --> point
