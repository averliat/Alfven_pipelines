...
for i in range(len(tag)):
    i=len(tag)-i-1
    tsmco.trace_moment_cin_all(base_simu+tag[i],tag[i],1,output_max[i],width_bar[i],hist,diff_abs,diff_relat,legend[i],marker[i],t1[i],moyenne_glissante=moyenne_glissante)
